...
$('input[name="first_day"], input[name="last_day"]').datetimepicker({
  timepicker:false,
  format:'Y-m-d',
  lang:"pt-BR",
});

$('input[name="registration_opened"], input[name="registration_closed"], input[name="cfp_opened"], input[name="cfp_closed"]').datetimepicker({
  format:'Y-m-d H:i:00',
  lang:"pt-BR",
});